...
def create_story_agent():
    ...
    story_agent = Agent(
        ...
        **Core Task:** Write a short, engaging story vignette (around 80-120 words) illustrating a specific problem an AI agent encounters while selling a camera online for its user. 
