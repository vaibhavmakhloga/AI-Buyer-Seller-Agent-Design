...
def main():
    ...
    if st.session_state.started:
        ...
        <ul>
            ...
            <li>What, if anything, could you have done differently when initially defining the task or instructions for the agent to potentially prevent this outcome or handle it better? 
            <li>What rules or information should you have given the agent beforehand to prevent this?
        </ul>
        </div>
        """, unsafe_allow_html=True)
